      ...
      <div className="mt-4 flex flex-row justify-between text-sm lg:text-base">
        <div className="flex flex-col  items-center first:items-start last:items-end">
          ...
          <div className="text-xs ">
            Upload any image you&apos;d like to Morph! This is the original
            image.
          </div>
        </div>
        <div className="flex flex-col  items-center first:items-start last:items-end">
          ...
          <div className="text-xs ">
            Then upload another image with the target face you&apos;d like to
            morph into.
          </div>
        </div>
        <div className="flex flex-col items-center first:items-start last:items-end">
          ...
          <div className="text-xs ">
            Click on Morph button and let the magic happen!
          </div>
        </div>
      </div>
    </div>
